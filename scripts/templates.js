...
function notificationTemplate(){
    return `<img class='fireworks' src="./assets/img/fireworks.gif" alt="Feuerwerke">
            <p class='user-notification'>Gratulation! Sie haben eine Test-Bestellung abgegeben!</p>
            <img class='fireworks' src="./assets/img/fireworks.gif" alt="Feuerwerke">`
}
